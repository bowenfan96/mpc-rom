...
class HeatEqSimulator:
    def __init__(self, duration=1, N=5):
        ...
        self.A = [[-1.5438, 0.1804, 4.7586, -3.1216, 0.7148],
                  [0.6929, -2.5428, 1.8534, 13.2137, 0.9641],
                  [-4.6539, -1.4846, -26.2580, 5.1627, -10.5949],
                  [3.4251, -13.3449, 9.4989, -39.0191, -2.3596],
                  [0.1959, 1.6399, 6.7073, 9.4591, -52.2773]]
        self.A = np.array(self.A)

        self.B = [[-4.8102, -3.4024],
                  [3.8286, -2.8837],
                  [-4.3839, -7.2643],
                  [9.3042, -2.9561],
                  [-0.7036, 1.6478]]
        ...
        self.C = [[-0.2321, 0.1796, 0.2279, -0.4602, 0.0172],
                  [-0.1814, -0.1587, 0.3578, 0.1628, 0.0889]]
        ...
        self.model.x[0, 0].fix(-1195.649)
        self.model.x[1, 0].fix(-130.532)
        self.model.x[2, 0].fix(93.918)
        self.model.x[3, 0].fix(5.7289)
        self.model.x[4, 0].fix(9.6416)
