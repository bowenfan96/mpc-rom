...
class HeatEqSimulator:
    def __init__(self, duration=1):
        ...
        x_init = [0.623746, -0.629622, -1.069584]
        ...
        self.sindy_dataMin = np.array([0.4032871, -0.9662344, -1.677114]).flatten()
        self.sindy_dataMax = np.array([0.94944113, -0.47337604, -0.6375582]).flatten()
        self.ae_dataMin = np.array([182.7997, 193.3699, 202.7192, 210.8632, 217.8229, 223.623,  228.2624, 231.7888, 234.2273, 235.5974, 235.9124, 235.1791, 233.3824, 230.4251, 226.341,  221.1054, 214.6942, 207.0872, 198.271,  186.1254]).flatten()
        self.ae_dataMax = np.array([437.6874, 410.5294, 389.3565, 372.7515, 359.7538, 349.6972, 342.1139, 336.6767, 333.1643, 331.4397, 331.4374, 333.1576, 336.6663, 342.1009, 349.6827, 359.7426, 372.7442, 389.352,  410.5268, 437.6862]).flatten()
