...
def generate_trajectories(save_csv=False):
    ...
    if save_csv:
        simple_60_trajectories_df.to_csv("simple_240_trajectories_df.csv")
...
if __name__ == "__main__":
    ...
    # replay("simple_240_trajectories_df.csv")

    main_simple_sys = SimpleSimulator()
    main_simple_sys.mpc_control()
    main_res, _ = main_simple_sys.parse_mpc_results()
    main_simple_sys.plot(main_res)