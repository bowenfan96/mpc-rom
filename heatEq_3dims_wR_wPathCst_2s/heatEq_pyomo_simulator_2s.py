...
class HeatEqSimulator:
    def __init__(self, duration=2, N=20):
        ...
        discretizer.apply_to(self.model, nfe=20, ncp=4, scheme="LAGRANGE-RADAU")
    ...
    def parse_mpc_results(self):
        ...
        timesteps = [timestep / 10 for timestep in range(21)]
    ...
    def simulate_system_nn_controls(self, nn_model):
        ...
        for i in range(21):
            ...
            tsim, profiles = sim.simulate(numpoints=21, varying_inputs=self.model.var_input)
    ...
    def plot(self, dataframe, num_rounds=0, num_run_in_round=0):
        ...
        fig.suptitle("MPC Controller (2 seconds): Cost achieved = {}\n"
                     "Heat Equation with Radiative Loss and Path Constraint".format(total_cost))
        plt.xlabel("Time")

        # Save plot with autogenerated filename
        svg_filename = "NN_Controller.svg"
